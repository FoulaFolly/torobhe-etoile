...
def ajouter_vendeur(nom,addresse,telephone,email):
...
def rechercher_vendeur(telephone):
...
def supprimer_vendeur(telephone):
    ...
    try:
        ...
        cur.execute("DELETE FROM Vendeurs WHERE telephone = %s", (telephone,))
...
if __name__ == '__main__':
    numberTel=int(input("give the vendor's number: "))
    rechercher_vendeur(numberTel)
    #supprimer_vendeur(numberTel)
